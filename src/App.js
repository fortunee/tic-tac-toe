...
class App extends Component {
  ...
  checkWinner(boxes, totalMoves) {
    ...
    for(let i=0;i<possibleWinnerMoves.length;i++) {
      if(boxes[possibleWinnerMoves[i][0]] === boxes[possibleWinnerMoves[i][1]] 
        && boxes[possibleWinnerMoves[i][1]] === boxes[possibleWinnerMoves[i][2]])
          return boxes[possibleWinnerMoves[i][0]];
  ...
  render() {
    return (
      <div id="game">
        <Grid checkWinner={this.checkWinner.bind(this)} />
